...
\zadatak{2}{Пребројавање непонављајућих вредности у низу}
Написати алгоритам временске комплексности $O(n)$ који ће претражити низ целих бројева и пребројати све вредности које се не понављају.
...
\zadatak{3}{Пребројавање чворова на позицији листова}
У оквиру стандардне структуре класе \texttt{AVL} написати имплементацију методе која ће омогућити пребројавање свих чворова који се налазе на позицији листова.
...
public void countLeaves()
	...
	\begin{Verbatim}[fontsize=\footnotesize, numbers=left, xleftmargin=10mm]
private void countLeavesAVL(Node curr)
	\end{Verbatim}
...
\begin{itemize}
	...
	\item \textbf{Излаз 2:} 5 (3, 5, 9, 14, 27)
\end{itemize}



\sablon{Шаблон другог теста јануар 2024. група C}{2023/Januar/GrupaC/AISP2023_Test2_GrupaC.linq}
