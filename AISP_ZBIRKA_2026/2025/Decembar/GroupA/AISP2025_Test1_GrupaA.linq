...
// ZADATAK 2 - Spajanje dve jednostruko spregnute liste
public static LinkedList MergingTwoLinkedLists (LinkedList list1, LinkedList list2){
	return null;
}
...
public void MatryoshkaDollSort(int[] arr){
