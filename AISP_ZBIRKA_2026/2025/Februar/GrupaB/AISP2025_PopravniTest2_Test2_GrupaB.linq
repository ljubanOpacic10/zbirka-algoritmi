...
// ZADATAK 1 - Konverzija matrice u listu susedstva
// -------------------------------------------------
public class GFG
{
	...
	public void addVertex(List<LinkedList> adjacencyList)
	{
		adjacencyList.Add(new LinkedList());//dodavanje novog cvora u graf podrazumeva dodavanje nove prazne j.p.liste
	}
	
	// -------------------------------------------------
	public List<LinkedList> ConvertAdjacencyMatrixToAdjacencyList  (int[,] adjacencyMatrix, int vertex)
	{
		return null;
	}
	// -------------------------------------------------
...
// ZADATAK 2 - Karakter sa najdužim nizom bez ponavljanja
// -------------------------------------------------
public static int LengthOfLongestUnique(string str)
{
    return 0;
}
// -------------------------------------------------
...
// ZADATAK 3 - Provera maksimalne dubine lista (Max Leaf Depth)
// -------------------------------------------------
public class BinarySearchTree
{
	...
	// -------------------------------------------------
	public bool hasLeafDeeperThan(int k)
	{
	   	return false;
	}

	private bool hasLeafDeeperThan (Node current, int level, int k)
	{
		return false;
	}
	// -------------------------------------------------
