...
// ZADATAK 1 - Merge sort - metoda merge
// -----------------------------------------------------
public class MergeSort
{
	...
	private static void mergeSrt(long[] arr, long[] tmpArray, int lowerIndex, int upperIndex)
	{
		...
		mergeSrt(arr, tmpArray, lowerIndex, middleIndex); 
		mergeSrt(arr, tmpArray, middleIndex+1, upperIndex); 
		merge(arr, tmpArray, lowerIndex, middleIndex, upperIndex); 
	}
	...
	{
		int size = arr.Length;
		long[] tmpArray = new long[size]; 
		mergeSrt(arr, tmpArray, 0, size-1); 
	}
}
...
// ZADATAK 2 – Promena redosleda n elemenata steka, koristeći red 
// -----------------------------------------------------
...
// ZADATAK 3 - Broj i suma uvala i bregova u jednostruko povezanoj listi
// -----------------------------------------------------
public class LinkedList
{
	...
	//----------------------------------------------------------------------------------
 	public int[] CoundAndSumValleysAndPeaks() {}
